...
class DepthIndicatorColorSpecifier : public parcast::IPilotIndicatorColorSpecifier
{
public:
	DepthIndicatorColorSpecifier(std::shared_ptr<const parcast::IPositionInPlanCoordinateSystemCalculatorGetter> positionCalculator,
