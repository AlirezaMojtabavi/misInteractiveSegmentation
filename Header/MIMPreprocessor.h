...
public:
  ...
  //   IMPORTANT NOTE : in this project only Rigid3D transform Type used
...
//   typedef typename AffineTransformType::Pointer AffineTransformPointer;
  ...
  Rigid3DTransformPointer GetPostTransform()
    { return m_PostTransform; }

  /** Get computed pre transform. */
  Rigid3DTransformPointer GetPreTransform()
