...
MOCK_BASE_CLASS(MockVolumeSlicer, IVolumeSlicer)
{
	...
	MOCK_NON_CONST_METHOD(GetImageRprensentaion, 0, std::shared_ptr<misPlanarRepresentation>());
	...
	MOCK_NON_CONST_METHOD (GetOrientationDirection, 0, IMAGEORIENTATION () );
	...
	MOCK_NON_CONST_METHOD(InitializeWidget, 1, void(misCursorType widgetType));
