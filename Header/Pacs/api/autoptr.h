...
namespace GNC {
	...
	class MISDLLEXPORT PtrCounter : public GNC::GCS::ILockable
	{
	public:
...
namespace GNC {
	namespace GCS {
		...
		class MISDLLEXPORT NullPointerException : public GNC::GCS::IException
		{
		public:
		...
		template <typename X>
		class MISDLLEXPORT Ptr : public ILockable
		{
