...
namespace GNC {
	...
	namespace GCS {
		class MISDLLEXPORT IComando;
		class MISDLLEXPORT ICommandController;
	}
}
//endregion
...
namespace GNC {
	namespace GCS {
		...
		//---------------------------------------------------------------------------------------
		class MISDLLEXPORT IComandoParams {
		public:
			IComandoParams();
		...
		//---------------------------------------------------------------------------------------
		class MISDLLEXPORT IComandoResult {
		public:
			IComandoResult();
		...
		//---------------------------------------------------------------------------------------
		class MISDLLEXPORT IComando : public GNC::IProxyNotificadorProgreso {
			//---------------------------------------------------------------------------------------
		...
		class MISDLLEXPORT IPersistentCommand: public GNC::GCS::IComando
		{
		public:
			typedef enum {
				Pending = 0,
