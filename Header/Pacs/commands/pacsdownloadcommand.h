...
namespace GADAPI {
	class MISDLLEXPORT PACSDownloadCommandParams : public GNC::GCS::IComandoParams {

	public:
		//download only specifying 
		PACSDownloadCommandParams(const std::string& serverSeleccionado, const GIL::DICOM::DicomDataset& base, bool link = false);
	...
	class MISDLLEXPORT PACSDownloadCommand : public GNC::GCS::IComando {
	public:
