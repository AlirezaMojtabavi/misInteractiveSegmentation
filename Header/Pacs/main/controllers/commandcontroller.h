...
namespace GNC {
	class MISDLLEXPORT CommandController;
	class MISDLLEXPORT ThreadPool;	
}
...
namespace GNC {
	...
	//----------------------------------------------------------------------------------------------------
	//----------------------------------------------------------------------------------------------------
	class MISDLLEXPORT CommandLauncher : public wxThread, public GNC::GCS::WaitQueueTask, public GNC::INotificadorProgreso {
	public:
		//id Ginkgo
	...
	//----------------------------------------------------------------------------------------------------
	//----------------------------------------------------------------------------------------------------
	class MISDLLEXPORT CommandController : public GNC::GCS::ICommandController, public GNC::GCS::ILockable {
	public:
