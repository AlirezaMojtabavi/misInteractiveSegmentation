...
public:
	...
	DicomServer(const std::string& ID, const std::string& AET, const std::string& HostName, int port, std::string& RetrieveMethod) ;
...
class MISDLLEXPORT DicomServerList: public GNC::GCS::ILockable {
public:
...
protected:
	...
	void ReadPACSSettingFromXmlFile();
