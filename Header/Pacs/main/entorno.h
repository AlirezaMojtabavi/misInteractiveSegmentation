...
namespace GNC {
	class MISDLLEXPORT Entorno : public GNC::GCS::IEntorno {
	public:
	...
	public:
		...
		virtual void  SetDicomLocalAET(std::string& myLocalAET);
		virtual int  GetDicomLocalPort();
		virtual void SetDicomLocalPort(int& myLocalPort);
		...
		virtual int* GetControladorVistas();
		...
		//virtual int NewWidgetsManager(GNC::GCS::IVista* pVista);
