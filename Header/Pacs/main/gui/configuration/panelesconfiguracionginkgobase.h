...
class DialogoConfiguracionBase : public wxDialog 
{
	...
	public:
		...
		DialogoConfiguracionBase( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxEmptyString, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 830,565 ), long style = wxDEFAULT_DIALOG_STYLE|wxMAXIMIZE_BOX|wxRESIZE_BORDER );
...
class PanelConfiguracionGeneralBase : public wxPanel 
{
	...
	protected:
		...
		virtual void OnCheckEnableProxySettings( wxCommandEvent& event ) { event.Skip(); }
		virtual void OnProxySettings( wxCommandEvent& event ) { event.Skip(); }
...
class LocalDatabaseConfigurationPanelBase : public wxPanel 
{
	...
	protected:
		...
		virtual void OnCheckOlderStudies( wxCommandEvent& event ) { event.Skip(); }
		virtual void OnOptionModified( wxCommandEvent& event ) { event.Skip(); }
		virtual void OnCheckHDSpace( wxCommandEvent& event ) { event.Skip(); }
		virtual void OnSpinCtrl( wxSpinEvent& event ) { event.Skip(); }
		virtual void OnCheckDicomDirSize( wxCommandEvent& event ) { event.Skip(); }
...
class DialogoServidorPACSBase : public wxDialog 
{
	...
	protected:
		...
		// Virtual event handlers, overide them in your derived class
		virtual void OnRetrieveMethodChoice( wxCommandEvent& event ) { event.Skip(); }
		virtual void OnChecWL( wxCommandEvent& event ) { event.Skip(); }
		virtual void OnMessageDefaultValues( wxCommandEvent& event ) { event.Skip(); }
	...
	public:
		...
		DialogoServidorPACSBase( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("DICOM Node"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( -1,-1 ), long style = wxDEFAULT_DIALOG_STYLE|wxRESIZE_BORDER );
...
class DialogoLocalPACSBase : public wxDialog 
{
	...
	public:
		...
		DialogoLocalPACSBase( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("Advanced Settings"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 346,300 ), long style = wxDEFAULT_DIALOG_STYLE|wxRESIZE_BORDER );
...
class ProfileDialogBase : public wxDialog 
{
	...
	public:
		...
		ProfileDialogBase( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("Edit profile"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( -1,-1 ), long style = wxCAPTION|wxCLOSE_BOX|wxMAXIMIZE_BOX|wxMINIMIZE_BOX|wxRESIZE_BORDER|wxSYSTEM_MENU );
		~ProfileDialogBase();
...
class HangingProtocolConfigurationPanelBase : public wxPanel 
{
	...
	protected:
		...
		wxTreeListCtrl* m_pTreeListProtocols;
		wxButton* m_button3;
		wxButton* m_pBEdit;
		wxButton* m_pBDelete;
...
class EditHangingProtocolDialogBase : public wxDialog 
{
	...
	protected:
		...
		wxPanel* m_pVisualizationPanel;
		wxSplitterWindow* m_splitter4;
		wxPanel* m_panel90;
		wxTreeCtrl* m_pTreeNavigation;
		TitledPanelSinBorder* m_pTitledPanelModalities;
		...
		virtual void OnNavigationChanged( wxTreeEvent& event ) { event.Skip(); }
		virtual void OnOkClick( wxCommandEvent& event ) { event.Skip(); }
		virtual void OnCancelClick( wxCommandEvent& event ) { event.Skip(); }
	...
	public:
		...
		void m_splitter4OnIdle( wxIdleEvent& )
		{
			...
			m_splitter4->Disconnect( wxEVT_IDLE, wxIdleEventHandler( EditHangingProtocolDialogBase::m_splitter4OnIdle ), NULL, this );
		}
...
class ModalityPanelBase : public wxPanel 
{
	...
	protected:
		...
		// Virtual event handlers, overide them in your derived class
		virtual void OnAddWL( wxCommandEvent& event ) { event.Skip(); }
		virtual void OnEditWL( wxCommandEvent& event ) { event.Skip(); }
		virtual void OnDeleteWL( wxCommandEvent& event ) { event.Skip(); }
		
	
	public:
		wxChoice* m_pDefaultWindowLevel;
		
		ModalityPanelBase( wxWindow* parent, wxWindowID id = wxID_ANY, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 500,471 ), long style = wxTAB_TRAVERSAL );
		~ModalityPanelBase();
...
class StudyWindowBase : public wxPanel 
{
	...
	protected:
		...
		// Virtual event handlers, overide them in your derived class
		virtual void OnSetDefaultWindowPosition( wxCommandEvent& event ) { event.Skip(); }
		virtual void OnSetupWindowPositionClick( wxCommandEvent& event ) { event.Skip(); }
		virtual void OnSpinRows( wxSpinEvent& event ) { event.Skip(); }
		virtual void OnSpinCols( wxSpinEvent& event ) { event.Skip(); }
...
class EditCriteriaPanelBase : public wxPanel 
{
	...
	protected:
		wxTreeListCtrl* m_pTreeListCriteria;
		wxButton* m_button3;
		wxButton* m_pBDelete;
