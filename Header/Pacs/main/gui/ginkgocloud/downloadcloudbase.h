...
#ifndef __downloadcloudbase__
#define __downloadcloudbase__
	...
	namespace GUI
	{
		...
		class GinkgoCloudSearchDialogBase : public wxDialog 
		{
			...
			protected:
				...
				wxTreeListCtrlCloud* m_pTreeListResults;
		...
		class FileLinkDialogBase : public wxDialog 
		{
			...
			public:
				...
				FileLinkDialogBase( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxEmptyString, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 600,300 ), long style = wxDEFAULT_DIALOG_STYLE|wxRESIZE_BORDER );
				~FileLinkDialogBase();
