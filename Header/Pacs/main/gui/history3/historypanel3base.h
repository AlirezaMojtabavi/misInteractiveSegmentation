...
#ifndef __historypanel3base__
#define __historypanel3base__
...
#include "wxtreelistctrlhistory.h"
	...
	namespace GUI
	{
		...
		class HistoryPanel3Base : public wxFrame 
		{
			...
			protected:
				...
				wxBitmapComboBox* m_pPatientCombo;
				...
				wxStaticText* m_pResultTitle;
				
				wxStaticText* m_staticText3;
				wxChoice* m_pChoiceColumns;
				wxTreeListCtrlHistory* m_pTreeListResults;
				...
				virtual void OnHistoryPanelIdle( wxIdleEvent& event ) { event.Skip(); }
				virtual void OnAdvancedSearchToggled( wxCommandEvent& event ) { event.Skip(); }
				virtual void OnKeyDownFormulario( wxKeyEvent& event ) { event.Skip(); }
				virtual void OnSearchChange( wxCommandEvent& event ) { event.Skip(); }
				virtual void OnDateChanged( wxDateEvent& event ) { event.Skip(); }
				virtual void OnSortColumnChanged( wxCommandEvent& event ) { event.Skip(); }
