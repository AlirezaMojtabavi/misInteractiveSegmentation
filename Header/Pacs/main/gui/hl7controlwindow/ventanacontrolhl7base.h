...
#ifndef __ventanacontrolhl7base__
#define __ventanacontrolhl7base__
	...
	namespace GUI
	{
		...
		class VentanaControlHL7Base : public wxFrame 
		{
			...
			protected:
				...
				wxTreeListCtrl* m_treeListCtrlMensajes;
		...
		class DialogoMostrarMensajeBase : public wxDialog 
		{
			...
			public:
				...
				DialogoMostrarMensajeBase( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("Message detail"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 516,306 ), long style = wxCAPTION|wxCLOSE_BOX|wxMAXIMIZE_BOX|wxRESIZE_BORDER|wxSYSTEM_MENU );
...
#endif //__ventanacontrolhl7base__
