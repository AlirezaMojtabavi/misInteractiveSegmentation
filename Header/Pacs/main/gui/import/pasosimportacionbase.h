...
#ifndef __pasosimportacionbase__
#define __pasosimportacionbase__
	...
	namespace GUI
	{
		...
		class PanelDatosGeneralesBase : public wxScrolledWindow
		{
			...
			public:
				...
				PanelDatosGeneralesBase( wxWindow* parent, wxWindowID id = wxID_ANY, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 807,538 ), long style = wxTAB_TRAVERSAL );
...
#endif //__pasosimportacionbase__
