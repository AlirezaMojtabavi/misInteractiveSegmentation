...
class AboutDialogBase : public wxDialog 
{
	...
	public:
		...
		AboutDialogBase( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxEmptyString, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 660,500 ), long style = wxCLOSE_BOX|wxDEFAULT_DIALOG_STYLE );
		~AboutDialogBase();
...
class DialogoLicenciasOpenSourceBase : public wxDialog 
{
	...
	public:
		...
		DialogoLicenciasOpenSourceBase( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("Open Source Licenses"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 700,476 ), long style = wxDEFAULT_DIALOG_STYLE );
