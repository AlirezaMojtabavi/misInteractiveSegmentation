	...
	namespace GUI
	{
		...
		class AcceptLicenseDialogBase : public wxDialog 
		{
			...
			public:
				...
				AcceptLicenseDialogBase( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("License agreement"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 523,519 ), long style = wxCLOSE_BOX|wxDEFAULT_DIALOG_STYLE );
