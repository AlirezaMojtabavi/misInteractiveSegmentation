...
#ifndef __ventanaprincipalbase__
#define __ventanaprincipalbase__
...
class VentanaPrincipalBase : public wxFrame 
{
	...
	protected:
		...
		virtual void OnVentanaPrincipalEraseBackground( wxEraseEvent& event ) { event.Skip(); }
		virtual void OnKeydown( wxKeyEvent& event ) { event.Skip(); }
		virtual void OnPanelActualizacionEraseBackground( wxEraseEvent& event ) { event.Skip(); }
		virtual void OnPanelActualizacionInternoEraseBackground( wxEraseEvent& event ) { event.Skip(); }
		...
		virtual void OnPanelCentralEraseBackground( wxEraseEvent& event ) { event.Skip(); }
		
	
	public:
		
		VentanaPrincipalBase( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxEmptyString, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 800,600 ), long style = wxDEFAULT_FRAME_STYLE|wxMAXIMIZE|wxRESIZE_BORDER|wxTAB_TRAVERSAL );
...
#endif //__ventanaprincipalbase__
