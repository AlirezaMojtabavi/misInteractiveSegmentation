...
#include <vector>
#include <widgets/observers/iobservadorpoligono.h>
...
namespace GNC {
	namespace GCS {
		namespace Widgets {
			...
			class WPoligonoBuilder : public GNC::GCS::Widgets::IWidgetBuilder, public GNC::GCS::Widgets::Notificadores::INotificadorPoligono {
			public:

				WPoligonoBuilder(ModoPoligono modo, GNC::GCS::IWidgetsManager* pManager, const GNC::GCS::TriggerButton& buttonMask, GNC::GCS::Widgets::Observadores::IObservadorPoligono* pObservador = NULL);
			...
			protected:
				...
				GNC::GCS::Widgets::WPoligono*  m_pPoligonoCreado;
				ModoPoligono                   m_Modo;
...
class WPoligono : public GNC::GCS::Widgets::IWidget, public GNC::GCS::Widgets::IWidgetSerializable {

//region "Constructor y destructor"
			public:
				WPoligono(ModoPoligono modo, IWidgetsManager* pManager, unsigned int vid, VerticesPoligono& vertices, float radioNodo, const char* nombre = "");

				~WPoligono();

//endregion
				//region "Serializado y desserializado"
				WPoligono(IWidgetsManager* pManager, long vid, wxXmlNode* nodo, float radioNodo = 5.0f);
...
//region "Propiedades geometricas"
			private:
				...
				friend std::ostream & operator<<(std::ostream& out, const WPoligono& /*w*/)
				{
					return out;
				}
