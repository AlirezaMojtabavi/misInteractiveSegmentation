...
//
#ifndef SWIG
bool EXTAPI operator == (const wxArrayInt& array1, const wxArrayInt& array2);
...
//
#if wxUSE_SPINBTN
WX_PG_DECLARE_EDITOR_WITH_DECL(SpinCtrl,EXTAPI)
#endif

#if wxUSE_DATEPICKCTRL
WX_PG_DECLARE_EDITOR_WITH_DECL(DatePickerCtrl,EXTAPI)
#endif
...
*/
class EXTAPI wxColourPropertyValue : public wxObject
{
public:
...
#ifndef SWIG
bool EXTAPI operator == (const wxColourPropertyValue&, const wxColourPropertyValue&);

WX_PG_DECLARE_WXOBJECT_VARIANT_DATA(wxPGVariantDataColourPropertyValue, wxColourPropertyValue, EXTAPI)
#endif
...
*/
class EXTAPI wxFontProperty : public wxPGProperty
{
...
*/
class EXTAPI wxSystemColourProperty : public wxEnumProperty
{
...
WX_PG_DECLARE_CUSTOM_COLOUR_PROPERTY_USES_WXCOLOUR_WITH_DECL(wxColourProperty, class EXTAPI)
...
*/
class EXTAPI wxCursorProperty : public wxEnumProperty
{
...
EXTAPI const wxString& wxPGGetDefaultImageWildcard();

/** @class wxImageFileProperty
    @ingroup classes
    @brief Property representing image file(name).
*/
class EXTAPI wxImageFileProperty : public wxFileProperty
{
...
*/
class EXTAPI wxMultiChoiceProperty : public wxPGProperty
{
...
*/
class EXTAPI wxDateProperty : public wxPGProperty
{
...
class EXTAPI wxPGSpinCtrlEditor : public wxPGTextCtrlEditor
{
