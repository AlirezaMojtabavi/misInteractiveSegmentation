...
#ifndef SWIG
extern EXTAPI const wxChar *wxPropertyGridManagerNameStr;
#endif
...
*/
class EXTAPI wxPropertyGridPage : public wxEvtHandler,
...
*/
// BM_MANAGER
class EXTAPI wxPropertyGridManager : public wxPanel, public wxPropertyGridInterface
{
#ifndef SWIG
