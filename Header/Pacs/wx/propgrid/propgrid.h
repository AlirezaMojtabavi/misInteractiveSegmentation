...
extern EXTAPI const wxChar *wxPropertyGridNameStr;
...
/** @class wxPGDefaultRenderer
    ...
    scenarios.
*/
class EXTAPI wxPGDefaultRenderer : public wxPGCellRenderer
{
public:
    virtual void Render( wxDC& dc,
                         const wxRect& rect,
...
EXTAPI void wxPGTypeOperationFailed( const wxPGProperty* p, const wxChar* typestr, const wxChar* op );
EXTAPI void wxPGGetFailed( const wxPGProperty* p, const wxChar* typestr );
...
WX_PG_DECLARE_EDITOR_WITH_DECL(TextCtrl,EXTAPI)
WX_PG_DECLARE_EDITOR_WITH_DECL(Choice,EXTAPI)
WX_PG_DECLARE_EDITOR_WITH_DECL(ComboBox,EXTAPI)
WX_PG_DECLARE_EDITOR_WITH_DECL(TextCtrlAndButton,EXTAPI)
#if wxPG_INCLUDE_CHECKBOX
WX_PG_DECLARE_EDITOR_WITH_DECL(CheckBox,EXTAPI)
#endif
WX_PG_DECLARE_EDITOR_WITH_DECL(ChoiceAndButton,EXTAPI)
...
*/
class EXTAPI wxPGVariantData : public wxVariantData
{
#if !wxCHECK_VERSION(2,9,0)
...
// With wxWidgets 2.9 and later we demand native C++ RTTI support
    ...
    #define wxPGVariantDataGetClassInfo(A) (A->GetClassInfoWx())
    #define wxPG_VARIANT_EQ(A, B) ( ((A).GetData() && (B).GetData() && (A).GetData()->GetClassInfoWx() == (B).GetData()->GetClassInfoWx() && (A == B)) || (!(A).GetData() && !(B).GetData()) )
#endif
...
public: \
    virtual void* GetValuePtr() { return (void*)&m_value; } \
    virtual wxClassInfo* GetValueClassInfo() { return m_value.GetClassInfoWx(); } \
}; \
_WX_PG_IMPLEMENT_VARIANT_DATA(CLASSNAME, DATATYPE, DATATYPE&, const DATATYPE&, (DATATYPE&)*((DATATYPE*)NULL), wxPGVariantData)
...
WX_PG_DECLARE_VARIANT_DATA(wxPGVariantDataPoint, wxPoint, EXTAPI)
WX_PG_DECLARE_VARIANT_DATA(wxPGVariantDataSize, wxSize, EXTAPI)
WX_PG_DECLARE_VARIANT_DATA(wxPGVariantDataArrayInt, wxArrayInt, EXTAPI)
WX_PG_DECLARE_VARIANT_DATA(wxPGVariantDataLongLong, wxLongLong, EXTAPI)
WX_PG_DECLARE_VARIANT_DATA(wxPGVariantDataULongLong, wxULongLong, EXTAPI)
#ifdef __WXPYTHON__
    WX_PG_DECLARE_PTR_VARIANT_DATA(wxPGVariantDataPyObject, PyObject, EXTAPI)
#endif

WX_PG_DECLARE_WXOBJECT_VARIANT_DATA(wxPGVariantDataFont, wxFont, EXTAPI)
#if !wxCHECK_VERSION(2,8,0)
    WX_PG_DECLARE_WXOBJECT_VARIANT_DATA(wxPGVariantDataColour, wxColour, EXTAPI)
#else
...
EXTAPI long wxPGVariantToInt( const wxVariant& variant, long defVal = 1 );

// Safely converts a wxVariant to wxLongLong_t. Returns true on success.
EXTAPI bool wxPGVariantToLongLong( const wxVariant& variant, wxLongLong_t* pResult );

// Safely converts a wxVariant to wxULongLong_t. Returns true on success.
EXTAPI bool wxPGVariantToULongLong( const wxVariant& variant, wxULongLong_t* pResult );

// Safely converts a wxVariant to double. Supports converting from string and wxLongLong as well.
EXTAPI bool wxPGVariantToDouble( const wxVariant& variant, double* pResult );

// Convert wxVariant from various forms to a wxObject pointer
EXTAPI bool wxPGVariantToWxObjectPtr( const wxVariant& value,
                                              wxObject** result );
...
EXTAPI void wxPGInitResourceModule();
...
#if wxPG_USE_STL
typedef std::list<wxPGProperty*>  wxArrayPGProperty;
#else
WX_DEFINE_TYPEARRAY_WITH_DECL_PTR(wxPGProperty*, wxArrayPGProperty,
                                  wxBaseArrayPtrVoid, class EXTAPI);
#endif
...
*/
class EXTAPI wxPGAttributeStorage
{
public:
...
*/
class EXTAPI wxPGProperty : public wxObject
{
#ifndef SWIG
...
public:
    ...
    */
    ...
    const wxChar* GetClassNameGr() const
    {
		DebugBreak();
		return "";
...
*/
class EXTAPI wxPGRootProperty : public wxPGProperty
{
public:
...
*/
class EXTAPI wxPropertyCategory : public wxPGProperty
{
...
*/
class EXTAPI wxPGChoiceEntry : public wxPGCell
{
public:
    wxPGChoiceEntry();
...
// -----------------------------------------------------------------------
    ...
    WX_DECLARE_OBJARRAY_WITH_DECL(double, wxArrayDouble, class EXTAPI);
  #endif
#endif // !SWIG
...
EXTAPI wxObject* wxPG_VariantToWxObject( const wxVariant& variant, wxClassInfo* classInfo );
...
*/
class EXTAPI wxPropertyGridIteratorBase
{
public:
...
*/
class EXTAPI wxPropertyGridIterator : public wxPropertyGridIteratorBase
{
public:
...
*/
class EXTAPI wxPropertyGridConstIterator : public wxPropertyGridIteratorBase
{
public:
...
*/
class EXTAPI wxPGVIteratorBase
{
...
*/
class EXTAPI wxPropertyGridHitTestResult
{
    friend class wxPropertyGrid;
public:
...
*/
// BM_STATE
class EXTAPI wxPropertyGridState
{
...
*/
class EXTAPI wxPropertyGridInterface
// BM_METHODS
{
    friend class wxPropertyGrid;
    friend class wxPropertyGridManager;
...
*/
// BM_GRID
class EXTAPI wxPropertyGrid : public wxScrolledWindow, public wxPropertyGridInterface
{
#ifndef SWIG
    friend class wxPropertyGridState;
    friend class wxPropertyGridInterface;
...
BEGIN_DECLARE_EVENT_TYPES()
    DECLARE_EXPORTED_EVENT_TYPE(EXTAPI, wxEVT_PG_SELECTED,           wxPG_BASE_EVT_PRE_ID)
    DECLARE_EXPORTED_EVENT_TYPE(EXTAPI, wxEVT_PG_CHANGING,           wxPG_BASE_EVT_PRE_ID+1)
    DECLARE_EXPORTED_EVENT_TYPE(EXTAPI, wxEVT_PG_CHANGED,            wxPG_BASE_EVT_PRE_ID+2)
    DECLARE_EXPORTED_EVENT_TYPE(EXTAPI, wxEVT_PG_HIGHLIGHTED,        wxPG_BASE_EVT_PRE_ID+3)
    DECLARE_EXPORTED_EVENT_TYPE(EXTAPI, wxEVT_PG_RIGHT_CLICK,        wxPG_BASE_EVT_PRE_ID+4)
    DECLARE_EXPORTED_EVENT_TYPE(EXTAPI, wxEVT_PG_PAGE_CHANGED,       wxPG_BASE_EVT_PRE_ID+5)
    DECLARE_EXPORTED_EVENT_TYPE(EXTAPI, wxEVT_PG_ITEM_COLLAPSED,     wxPG_BASE_EVT_PRE_ID+6)
    DECLARE_EXPORTED_EVENT_TYPE(EXTAPI, wxEVT_PG_ITEM_EXPANDED,      wxPG_BASE_EVT_PRE_ID+7)
    DECLARE_EXPORTED_EVENT_TYPE(EXTAPI, wxEVT_PG_DOUBLE_CLICK,       wxPG_BASE_EVT_PRE_ID+8)
    DECLARE_EXPORTED_EVENT_TYPE(EXTAPI, wxEVT_PG_LABEL_EDIT_BEGIN,   wxPG_BASE_EVT_PRE_ID+9)
    DECLARE_EXPORTED_EVENT_TYPE(EXTAPI, wxEVT_PG_LABEL_EDIT_ENDING,  wxPG_BASE_EVT_PRE_ID+10)
...
/** @class wxPropertyGridEvent
    ...
    <wx/propertygrid/propertygrid.h>
*/
class EXTAPI wxPropertyGridEvent : public wxCommandEvent
{
public:
...
*/
class EXTAPI wxPropertyGridPopulator
{
public:
    /** Default constructor.
    */
