...
class EXTAPI wxTreeListItem;
class EXTAPI wxTreeListHeaderWindow;
class EXTAPI wxTreeListMainWindow;
...
class wxTreeListItemPublic {
	virtual std::list<wxTreeItemId> GetPublicChildren() const = 0;
};

class EXTAPI wxTreeListColumnInfo: public wxObject {
...
extern EXTAPI const wxChar* wxTreeListCtrlNameStr;


class EXTAPI wxTreeListCtrl : public wxControl
{
