...
#ifndef __wxwizardginkgobasewx__
#define __wxwizardginkgobasewx__
...
class wxWizardGinkgoBaseWx : public wxDialog 
{
	...
	public:
		...
		wxWizardGinkgoBaseWx( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("Test title"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 840,565 ), long style = wxDEFAULT_DIALOG_STYLE|wxMAXIMIZE_BOX|wxRESIZE_BORDER );
		~wxWizardGinkgoBaseWx();
	
};

#endif //__wxwizardginkgobasewx__
