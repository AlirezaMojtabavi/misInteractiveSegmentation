...
class  MISCOMMONEXPORT TextLog : public Log
{
public:
 ...
 */
class MISCOMMONEXPORT ConsoleLog : public Log {
public:
...
class MISCOMMONEXPORT HtmlLog : public Log {
public:
...
class MISCOMMONEXPORT LogManager
{
public:
