 ...
 * \ingroup Object
 */
class   igstkAnnotation2DModified
	: public igstk::Object
{
public:

  /* Macro with standard traits declarations. */
  igstkStandardClassTraitsMacro( igstkAnnotation2DModified, Object )
...
private:
  ...
  igstkAnnotation2DModified( void );
  ~igstkAnnotation2DModified( void );
...
public:
  ...
  igstkAnnotation2DModified( const Self & ); //purposely not implemented
  void operator=(const Self&);  //purposely not implemented

  ActorsListType                   m_Actors;

  std::string                      m_AnnotationText[20];
  std::string                      m_AnnotationTextToBeAdded;
  vtkTextActor  *                  m_AnnotationActor[20];
  vtkTextActor  *                  m_ActorToBeAdded;
  vtkTextProperty *                m_TextProperty[20];
