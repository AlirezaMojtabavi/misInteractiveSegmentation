...
void DICOMImageReader<TPixelType>::ReadDirectoryFileNamesProcessing()
{
  ...
  igstkLogMacro( DEBUGLOGGING, "igstk::DICOMImageReader will open seriesUID: " 
...
void DICOMImageReader<TPixelType>::AttemptReadImageProcessing()
{
  ...
  if( itk::ExposeMetaData<std::string>(dict,tagkey, m_GantryTilt ) )
    {
    igstkLogMacro( DEBUGLOGGING, "Gantry Tilt = " << m_GantryTilt << "\n" );
  ...
  if( itk::ExposeMetaData<std::string>(dict,modalityTagKey, m_Modality ) )
    {
    igstkLogMacro( DEBUGLOGGING, "Modality     = " << m_Modality << "\n" );
  ...
  if( itk::ExposeMetaData<std::string>(dict,patientNameTagKey, m_PatientName ) )
    { 
    igstkLogMacro( DEBUGLOGGING, "Patient Name = " << m_PatientName << "\n" );
    }
  ...
  if( itk::ExposeMetaData<std::string>(dict,patientIDTagkey, m_PatientID ) )
    { 
    igstkLogMacro( DEBUGLOGGING, "Patient ID = " << m_PatientID << "\n" );
    }
...
{
  igstkLogMacro( DEBUGLOGGING, "igstk::DICOMImageReader::ResetReader called...\n" );
...
{
  igstkLogMacro( DEBUGLOGGING, "igstk::DICOMImageReader::\
