...
{
  igstkLogMacro( DEBUGLOGGING, "RequestGetITKImage() called ....\n");
...
{
  igstkLogMacro( DEBUGLOGGING, "RequestGetVTKImage() called ....\n");
...
{
  igstkLogMacro( DEBUGLOGGING, "RequestGetImageTransform() called ....\n");
  Self * self = const_cast< Self * >( this );
...
{
  igstkLogMacro( DEBUGLOGGING, "RequestImageTransform() called ....\n");
...
{
  igstkLogMacro( DEBUGLOGGING, "RequestGetImageExtent() called ....\n");
  Self * self = const_cast< Self * >( this );
...
{
  igstkLogMacro( DEBUGLOGGING, "ReportImageTransformProcessing() called ....\n");
...
{
  igstkLogMacro( DEBUGLOGGING, "ReportITKImageProcessing() called ....\n");
...
{
  igstkLogMacro( DEBUGLOGGING, "ReportVTKImageProcessing() called ....\n");
...
{
  igstkLogMacro( DEBUGLOGGING, "ReportImageExtentProcessing() called ....\n");
...
::SetImageProcessing() 
{
  igstkLogMacro( DEBUGLOGGING, "SetImageProcessing() called ....\n");
