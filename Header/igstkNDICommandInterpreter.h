...
public:
  ...
  typedef enum
    ...
    NDI_57600    = 4,
    NDI_115200   = 5,
	NDI_921600    = 6, // Added by parsiss
	NDI_1228739   = 7, // Added by parsiss
    } COMMBaudType;
  ...
  typedef enum
    ...
    NDI_INCLUDE_OUT_OF_VOLUME = 0x0801,  /**< include out-of-volume tools */ 
  ...
  typedef enum
	...
	NDI_IR_Interference     = 0x04,
	NDI_TOOL_FACE_USED1      = 0x10,
	NDI_TOOL_FACE_USED2      = 0x20,
	NDI_TOOL_FACE_USED3      = 0x30,
	NDI_TOOL_FACE_USED4      = 0x40,
	NDI_TOOL_FACE_USED5      = 0x50,
	NDI_TOOL_FACE_USED6      = 0x60,
    NDI_TOOL_FACE_USED7      = 0x70,
	Unset_Tool_Info          = 0XFF,
    } TXToolInfoType;
  ...
  typedef enum
    ...
    NDI_MARKER_USED                = 3,
	NDI_MARKER_ButIsOutOfVolume    = 4,
	NDI_MARKER_Outside_Charecterized_Volume = 5,
	Unset_MarkerType = 255,
    } TXMarkerInfoType;
 ...
 /** GetSSTATSensor() return value bits */
  ...
  NDICommandInterpreter::TXToolInfoType GetTXToolInfo(int ph) const;
  ...
  NDICommandInterpreter::TXMarkerInfoType GetTXMarkerInfo(int ph, int marker) const;
...
private:
  ...
  // Not3 : 2 bits for tool information, 20 bits for markerInfo
  ...
  */
  ...
  void operator=(const Self&); //purposely not implemented
		...
		*****************************************************************************/
		...
		//---------------------------------------------------------------------------Added By MIS Team (A.M)
	private:

		/* Added By Mehdi*/		// MIS 
		bool m_GeneralStatus;
		bool m_Temprature;
		bool m_SCUInfo;
		bool m_BumpDetection;
		bool m_BumpInfo;
		bool m_STBInfo;
		bool m_LaserBatteryStatus;

		void HelperForGET(const char* crp); //  received text, with CRC hacked off
		/********************************************************************/
	...
	public:
		...
		/*IRRefreshRate*/
		void IRATE(int rate) {
			this->Command("IRATE:%01X", rate); }
		void VSEL(int vol) {
			this->Command("VSEL:%01X", vol); }

/////////////////////////////////////////////////////////////////////////////////////////////////////
//                                      Important Note
//                                     Use these functions in stop mode   

        bool GetLaserBatteryStatus(void);
        bool GetLaserStatus(void);
		bool SetLaserStatusOn(void);
		bool SetLaserStatusOff(void);
		...
		bool GetBumpInfo();
		bool GetSTBInfo();
		//int GetPortHandleStatus(int ph);

		char* GetCommandReply();
