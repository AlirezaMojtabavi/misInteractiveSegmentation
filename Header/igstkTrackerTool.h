...
public:
  ...
  ToolExtraInformation GetExtraInformation( void );
...
private:
  ...
  // Added by Parsiss, JHB add to marker Info
  void SetExtraInformation( const ToolExtraInformation extraInformation );
  ...
  // used for extar tool and marker status
  ToolExtraInformation m_ExtraInformation;
};
