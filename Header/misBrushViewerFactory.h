...
class misBrushViewerFactory :
	public IViewerFactory
{
public:
	std::shared_ptr<IVolumeSlicer> CreateImageViewer(std::shared_ptr<Iwindows> pWindow, int index,
		misSurgeryDirectionViewerType currentViewerProp, double VisibilityMarginInAnatomicalPlanesDirection,
		bool displayCross, vtkSmartPointer<misInteractorSTyleImageExtend>, misVolumeRendererContainer::Pointer dummy,
