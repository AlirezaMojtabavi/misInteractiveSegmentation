...
class misCMFNavigationSubSequence : public misMultiViewSubSequence
{
public:
	misCMFNavigationSubSequence(
		...
		std::shared_ptr<ICMFNavigationUIUpdater> CMFNavigationUIUpdater,
	...
	misCMFNavigationSubSequence(std::shared_ptr<INavigationLayout> layout,
...
private:
	...
	std::shared_ptr<ICMFNavigationUIUpdater> m_NavigationUIUpdater;
