...
class misENTSpineNavigationUIUpdater : public IENTNavigationUIUpdater
{
public:
	misENTSpineNavigationUIUpdater(const std::string& sequenceName, const std::string& subSequenceName,
