...
Module:    $RCSfile: misInteractionClass.h,v $
...
=========================================================================*/
// .NAME misInteractionClass - interactive manipulation of the camera
// .SECTION Description
// misInteractionClass allows the user to interactively
...
#ifndef __misInteractionClass_h
#define __misInteractionClass_h

#include "vtkInteractorStyle.h"

class  misInteractionClass : public vtkInteractorStyle
{
public:
	static misInteractionClass *New();
...
private:
	misInteractionClass(const misInteractionClass&);  // Not implemented.
	void operator=(const misInteractionClass&);  // Not implemented.
};
