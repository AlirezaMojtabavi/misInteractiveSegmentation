...
#include "ITracker.h"
#include "misMicronTracker.h"

class misMicronTrackerWrapper : public ITracker
{
public:
	misMicronTrackerWrapper(misMicronTracker::Pointer tracker);
...
private:
	misMicronTracker::Pointer m_Tracker;
};