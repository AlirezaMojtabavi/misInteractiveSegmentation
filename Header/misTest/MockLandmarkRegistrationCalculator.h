...
MOCK_BASE_CLASS(MockLandmarkRegistrationCalculator, ILandmarkRegistrationCalculator)
{
	...
	MOCK_CONST_METHOD(GetAllLandmarks, 0, std::shared_ptr<misPairLandMarkListType>());
