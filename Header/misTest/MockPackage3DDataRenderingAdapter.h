...
MOCK_BASE_CLASS(MockPackage3DDataRenderingAdapter, IPackage3DDataRenderingAdapter)
{
	MOCK_NON_CONST_METHOD(ModifyVolume, 0, void());
	MOCK_NON_CONST_METHOD(GetVolumeViewer, 0, std::shared_ptr<IVolume3DRenderer>());
	...
	MOCK_NON_CONST_METHOD(UpdateRepresentationTransforms, 2, void(std::shared_ptr<IVolumeRenderer>, std::
		shared_ptr<ISimpleDataPackage>), update_1);
	...
	MOCK_NON_CONST_METHOD(SetSceneReferenceCoordinateSystem, 2, void(const std::string& coordSysUid, std::shared_ptr<ISimpleDataPackage>));
