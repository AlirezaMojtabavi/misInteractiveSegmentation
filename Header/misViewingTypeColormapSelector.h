...
class misViewingTypeColormapSelector : public IViewingTypeColormapSelector
{
public:
	misViewingTypeColormapSelector(std::shared_ptr<INavigationViewersNView> groupViewer,
	                               std::unique_ptr<I3DModelTypeSelector> modelSelector,
	                               std::unique_ptr<ILandmarkVolumeSelector> volumelSelector,
...
private:
	...
	double m_CurrentVolumeThreshold = 0;
