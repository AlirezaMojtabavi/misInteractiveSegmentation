 ...
 */	
	class TGTLIBMISDLLEXPORT GlVersion {
		public:
		...
		friend TGTLIBMISDLLEXPORT bool operator==(const GlVersion& x, const GlVersion& y);
		friend TGTLIBMISDLLEXPORT bool operator!=(const GlVersion& x, const GlVersion& y);
		friend TGTLIBMISDLLEXPORT bool operator<(const GlVersion& x, const GlVersion& y);
		friend TGTLIBMISDLLEXPORT  bool operator<=(const GlVersion& x, const GlVersion& y);
		friend TGTLIBMISDLLEXPORT bool operator>(const GlVersion& x, const GlVersion& y);
		friend TGTLIBMISDLLEXPORT bool operator>(const GlVersion& x, const GlVersion& y);
		friend  TGTLIBMISDLLEXPORT  bool operator>=(const GlVersion& x, const GlVersion& y);
		friend TGTLIBMISDLLEXPORT std::ostream& operator<<(std::ostream& s, const GlVersion& v); 
...
class TGTLIBMISDLLEXPORT GpuCapabilities {
public:
...
template class TGTLIBMISDLLEXPORT Singleton<tgt::GpuCapabilities>;
