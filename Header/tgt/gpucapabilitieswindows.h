 ...
 */
class TGTLIBMISDLLEXPORT GpuCapabilitiesWindows : public tgt::GpuCapabilities {
public:
...
#define GpuCapsWin Singleton<tgt::GpuCapabilitiesWindows>::GetInstance()
template class TGTLIBMISDLLEXPORT Singleton<tgt::GpuCapabilitiesWindows>;
