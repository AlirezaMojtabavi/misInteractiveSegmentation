...
void TGTLIBMISDLLEXPORT init(InitFeature::Features featureset = InitFeature::ALL);
/// init GLEW and OpenGL-dependent singletons of tgt.
/// to be called when OpenGL context already exists.
void TGTLIBMISDLLEXPORT initGL(InitFeature::Features featureset = InitFeature::ALL);

/// deinit the singletons of tgt
void TGTLIBMISDLLEXPORT  deinit();
