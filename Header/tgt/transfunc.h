 ...
 */
	...
	class TGTLIBMISDLLEXPORT TransFunc {
public:
     ...
     */
    TransFunc(int width =2* 256, int height = 1, int depth = 1,
        GLint format = GL_RGBA, GLenum dataType = GL_UNSIGNED_BYTE, tgt::Texture::Filter filter = tgt::Texture::LINEAR);
