...
class VOREENEXPORTS VolumeHandleObserver : public Observer {
...
struct VOREENEXPORTS VolumeOrigin   {
...
class VOREENEXPORTS VolumeHandle : public Observable<VolumeHandleObserver> {
