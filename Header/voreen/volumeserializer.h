...
public:
     ...
     */
    void save(const std::string& filename, VolumeHandle* volume) const throw (FileException);
     ...
     * @param volume The Volume that should be saved.
     */
    void save(const std::string& filename, Volume* volume) const throw (FileException);
