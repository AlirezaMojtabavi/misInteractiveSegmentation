// .NAME vtkIterativeClosestPointTransform2 - Implementation of the ICP algorithm.
// .SECTION Description
...
//class VTK_HYBRID_EXPORT vtkIterativeClosestPointTransform2 : public vtkLinearTransform
...
public:
  ...
  static vtkPoints* EliminateFarPoints(vtkDataSet *target, vtkPoints* initialPoints);
...
private:
  vtkIterativeClosestPointTransform2(const vtkIterativeClosestPointTransform2&);  // Not implemented.
  void operator=(const vtkIterativeClosestPointTransform2&);  // Not implemented.
