...
/*  32bit */
    ...
    /*  Win32 */
        ...
        /*
          ...
          triggering the #error in the int typedefs below...
        */
...
/* Make sure int is defined (a signed type the same size as size_t) */
/* HAVE_SSIZE_T should be defined for compiliers that already have it */
    ...
    #else
        #error "error defining int, size_t is not 4 or 8 bytes"
    #endif

    /* prevent int redefinitions in other libraries */
    #define HAVE_SSIZE_T
#endif
