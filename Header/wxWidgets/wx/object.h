...
#define DECLARE_ABSTRACT_CLASS(name)                                          \
    public:                                                                   \
        ...
        virtual wxClassInfo *GetClassInfoWx() const;
...
#define wxIMPLEMENT_CLASS_COMMON(name, basename, baseclsinfo2, func)          \
    wxClassInfo name::ms_classInfo(wxT(#name),                                \
            ...
            (wxObjectConstructorFn) func);                                    \
                                                                              \
    wxClassInfo *name::GetClassInfoWx() const                                   \
...
{
    return obj && obj->GetClassInfoWx()->IsKindOf(classInfo) ? obj : NULL;
}
...
public:
    ...
    wxClassInfo *GetClassInfoWx() const
    {
#ifdef _MSC_VER
