...
// explicitly!
        ...
        #ifdef WXUSINGDLL
            #ifdef _DEBUG
                #include "mswud/wx/setup.h"
            #else
                #include "mswu/wx/setup.h"
            #endif
        #else
            #ifdef _DEBUG
                #include "mswd/wx/setup.h"
            #else
                #include "mswu/wx/setup.h"
            #endif
        #endif
        ...
        #else // static lib
            #ifdef _DEBUG
                #include "D:/API/Pacs/Pacs/Ginkgo/Prerequisits/wxWidget/wxWidgets/wxMSW-2.8.11/lib/vc_lib/mswd/wx/setup.h"
            #else
