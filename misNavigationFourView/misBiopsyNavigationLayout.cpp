#include "stdafx.h"
#include "..\Header\misBiopsyNavigationLayout.h"
#include "misGroupViewerSetting.h"
#include "misWidgetColorReader.h"
#include <misApplicationSetting.h>

std::shared_ptr<IGroupViewerSetting> misBiopsyNavigationLayout::GetLayout() const
{
...
std::shared_ptr<IGroupViewerSetting> misBiopsyNavigationLayout::GetLayoutFromFile(const std::string& layoutName)const
{
	std::string directory = FileSystem::currentDirectory();
	auto subDirectory = std::string("Biopsy");
