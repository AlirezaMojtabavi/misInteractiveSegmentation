/*=========================================================================
  ...
  Module:    $RCSfile: misViewDependentActor.h,v $
...
=========================================================================*/
// .NAME misViewDependentActor - a subclass of actor that always faces the camera
// .SECTION Description
// misViewDependentActor is a subclass of vtkActor that always follows its specified 
...
#ifndef __misViewDependentActor_h
#define __misViewDependentActor_h

class vtkCamera;

class misViewDependentActor : public vtkActor
{
 ...
 public:
  ...
  static misViewDependentActor *New();
...
private:
  misViewDependentActor(const misViewDependentActor&);  // Not implemented.
  void operator=(const misViewDependentActor&);  // Not implemented.
  float NearPlaneArea(vtkTransform* pTransform);
};
