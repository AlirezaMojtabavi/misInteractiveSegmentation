...
class SlicerPointSelectActionLandamrk : public vtkCommand
{
public:
	static SlicerPointSelectActionLandamrk* New();
	vtkBaseTypeMacro(SlicerPointSelectActionLandamrk, vtkCommand);
...
private:
	...
	SlicerPointSelectActionLandamrk();
