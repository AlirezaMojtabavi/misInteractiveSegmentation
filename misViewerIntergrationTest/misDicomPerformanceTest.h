...
public:
	...
	typedef misDicomPerformanceTest Self;
	...
	misDicomPerformanceTest()
	{
		...
		m_PusleObserver->SetCallbackFunction(this,&misDicomPerformanceTest::Render);
