...
public:
	...
	typedef misReleaseTextureTest Self;
	...
	//==========================================================================
	//==========================================================================
	misReleaseTextureTest(int type)
	{
		m_Type=type;
		slice=100;
		int *size;
		...
		m_PusleObserver->SetCallbackFunction(this,&misReleaseTextureTest::Render);
	...
	void AddImage()
	{
		...
		plane->SetImageData(0,pImageReader2->GetOutput());
		this->m_Viewer->Render();
		plane->SetImageData(0,pImageReader->GetOutput());
		this->m_Viewer->Render();
		plane->SetImageData(0,pImageReader2->GetOutput());
		...
		//this->m_Viewer->RemoveRepresentation(plane);
		this->m_Viewer->Render();
	...
	void Render()
	{
		...
		plane->SetCurrentImagePos(slice);
		if (slice>120)
			slice=0;
