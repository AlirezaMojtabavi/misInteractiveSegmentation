...
public:
	...
	typedef misTransformTextureTest Self;
...
//		this->LoadExtensionsSucceeded = true;
	...
	//==========================================================================
	misTransformTextureTest(int type)
	{
		m_Type=type;
		slice=100;
		int *size;
		...
		m_PusleObserver->SetCallbackFunction(this,&misTransformTextureTest::Render);
	...
	void AddImage()
	{
		...
		pImageReader->SetDirectoryName("E:\SE1");
		pImageReader->Update();
