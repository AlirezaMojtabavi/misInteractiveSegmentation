...
class misArrow : public vtkProp3D
{

public:
  static misArrow *New();
  vtkTypeRevisionMacro(misArrow,vtkProp3D);
  ...
  void SetShaftTypeToCylinder()
    { this->SetShaftType( misArrow::CYLINDER_SHAFT ); }
  void SetShaftTypeToLine()
    { this->SetShaftType( misArrow::LINE_SHAFT ); }
  void SetShaftTypeToUserDefined()
    { this->SetShaftType( misArrow::USER_DEFINED_SHAFT ); }
  ...
  void SetTipTypeToCone()
    { this->SetTipType( misArrow::CONE_TIP ); }
  void SetTipTypeToSphere()
    { this->SetTipType( misArrow::SPHERE_TIP ); }
  void SetTipTypeToUserDefined()
    { this->SetTipType( misArrow::USER_DEFINED_TIP ); }
...
private:
  misArrow(const misArrow&);  // Not implemented.
  void operator=(const misArrow&);  // Not implemented.
};
